<?php
	...
	$sql = "UPDATE Primera SET Matematicas = '$mate', Fisica = '$fisica', Ingles = '$ingles', Metodologia = '$meto',  Programacion = '$progra', Analisis = '$analisis', Internet = '$internet', Culturales = '$cult', Servicio = '$serv' WHERE numCuenta = '$account'";
