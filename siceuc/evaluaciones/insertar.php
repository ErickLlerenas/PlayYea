<?php
	...
	$sql = "INSERT INTO Primera (numCuenta,Matematicas,Fisica,Ingles,Metodologia,Programacion,Analisis,Internet,Culturales,Servicio) VALUES ('$numCuenta','$Matematicas','$Fisica','$Ingles','$Metodologia','$Programacion','$Analisis','$Internet','$Culturales','$Servicio')";
