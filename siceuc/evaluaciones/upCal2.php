<?php
	...
	$sql = "UPDATE Segunda SET Matematicas = '$mate', Fisica = '$fisica', Ingles = '$ingles', Metodologia = '$meto',  Programacion = '$progra', Analisis = '$analisis', Internet = '$internet', Culturales = '$cult', Servicio = '$serv' WHERE numCuenta = '$account'";
