<?php
	...
	$sql = "INSERT INTO Segunda (numCuenta,Matematicas,Fisica,Ingles,Metodologia,Programacion,Analisis,Internet,Culturales,Servicio) VALUES ('$numCuenta','$Matematicas','$Fisica','$Ingles','$Metodologia','$Programacion','$Analisis','$Internet','$Culturales','$Servicio')";
